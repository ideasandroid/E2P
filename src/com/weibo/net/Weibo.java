...
public class Weibo {
	...
	public static String APP_KEY = "2609238549";
	public static String APP_SECRET = "009873bb8c6a1e4368f00e42e07bac0b";
	...
	public String getUserInfo(Context context,Weibo weibo) 
	throws MalformedURLException, IOException, WeiboException{
		...
		String rlt = weibo.request(context, url, bundle, "GET", weibo.mAccessToken);
		return rlt;
	}
